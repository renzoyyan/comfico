...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'bg-white:80 dark:bg-gray-950:80 fixed inset-0 z-50 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
    ref={ref}
...
>(
  (
    { side = 'right', className, children, withOverlay = true, hideCloseBtn = false, ...props },
    ref
  ) => (
    <SheetPortal>
